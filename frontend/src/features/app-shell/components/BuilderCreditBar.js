...
const BuilderCreditBar = ({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-black/30 px-4 py-3 shadow-[0_0_24px_rgba(255,255,255,0.04)]">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <button
          type="button"
          className="inline-flex shrink-0 items-center justify-center rounded-xl border border-zinc-700 bg-black/30 px-4 py-2 text-xs font-semibold text-white transition hover:border-zinc-500"
        >
          Ampliar créditos
        </button>
      </div>
