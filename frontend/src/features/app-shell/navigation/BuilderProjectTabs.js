        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={`group inline-flex min-w-[180px] shrink-0 items-center gap-3 rounded-2xl border px-4 py-3 text-left transition ${
                isActive
                  ? 'border-white/[0.18] bg-white/[0.06] text-white shadow-[0_0_24px_rgba(255,255,255,0.05)]'
            ...
            >
              ...
              <span className="min-w-0 flex flex-col">
                ...
                <span className="truncate text-[11px] uppercase tracking-[0.14em] text-zinc-500">
                  {item.status}
                </span>
              </span>
