...
export function createInitialBuildState(input = {}) {
  ...
  return {
    ...
    commandStatus: text(input.commandStatus || input.command_status, ""),
    creditPolicy: isObject(input.creditPolicy || input.credit_policy) ? input.creditPolicy || input.credit_policy : null,
...
export function normalizeBuildState(state = {}) {
  ...
  return {
    ...
    commandStatus: text(state.commandStatus || state.command_status, base.commandStatus),
    creditPolicy: isObject(state.creditPolicy || state.credit_policy) ? state.creditPolicy || state.credit_policy : base.creditPolicy,
...
export function getBuildStateSummary(state = {}) {
  ...
  return {
    ...
    commandStatus: normalizedState.commandStatus,
