...
const normalizeReportView = (project) => {
  ...
  if (
    ...
    immediateAction = {
      title: priorityActions[0].title || 'Aplicar acci├│n prioritaria',
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-8">
              <div>
                ...
                <p className="text-[#CFCFCF] max-w-3xl leading-relaxed">
                  Validaci├│n breve y accionable para entender el caso, detectar la fricci├│n principal
              ...
              <div className="rounded-2xl border border-white/5 bg-[#111111] px-5 py-5 min-w-[260px]">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p className="text-[#D4D4D4]">
                    ...
                    {project.input_type === 'url' ? 'URL' : 'Descripci├│n'}
                  </p>
                </div>
              </div>
            </div>
          ...
          <PdfSection
            ...
            title={
              reportView.continuityRecommendation && signalGroups.length > 0
                ? 'Continuidad y se├▒ales complementarias'
                : reportView.continuityRecommendation
                  ? 'Continuidad recomendada'
                  : 'Se├▒ales complementarias'
            }
            ...
            {continuityMeta?.label && (
              ...
              >
                <p className="text-white leading-relaxed">
                  Con esta lectura ya puedes ver el caso con m├ís claridad.
                  {reportView.continuityRecommendation ? (
                    <>
                    ...
                    <>
                      {' '}El siguiente paso correcto es reforzar la parte m├ís d├®bil del caso antes de ampliar intensidad.
                    </>
                  )}
                </p>
              </div>
        ...
        {showSystemFooter && (
          <div className="px-8 py-5 sm:px-10 border-t border-white/5 bg-[#0B0B0B]">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-sm">
              <p className="text-[#D4D4D4]">
                {brandName} ┬À Validaci├│n breve y accionable
              </p>
              <p className="text-[#A3A3A3]">
                Documento preparado para vista premium y futura exportaci├│n PDF
              </p>
            </div>
          </div>
        )}
