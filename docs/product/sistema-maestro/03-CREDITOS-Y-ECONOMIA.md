...
Este documento define la lógica económica operativa de Sistema Maestro.
...
## 2. Principio económico general



Sistema Maestro debe sostenerse sobre tres motores de monetización complementarios:
...
## 3. Qué problema resuelven los créditos



Si el sistema permite construir, iterar y ejecutar con agentes, existe coste real para la plataforma.



Sin economía de créditos, el sistema corre estos riesgos:
...
Los créditos existen para resolver ese problema de forma limpia.
...
## 4. Qué no deben ser los créditos



Los créditos no deben sentirse como:
...
Los créditos deben sentirse como:
...
## 6. Qué debe entrar en suscripción



La suscripción debe cubrir:
...
## 7. Qué debe entrar en créditos



Los créditos deben aplicarse a acciones que consumen recursos y generan coste operativo claro.
...
## 8. Qué no debería consumir créditos



No conviene gastar créditos en acciones de entrada o lectura simple.
...
Las recargas deben existir como capa separada de la suscripción.
...
La economía futura debe prever recargas cerradas y simples.
...
No conviene empezar con demasiadas variantes.
...
Además del consumo normal de créditos, el sistema debe prever ciertas acciones premium con lógica propia.
...
La decisión exacta se cerrará en contratos técnicos y pricing final.
...
El despliegue no debe darse por incluido sin coste.
...
La exportación no debe confundirse con créditos normales.
...
Cuando el usuario agote créditos, el sistema debe responder con claridad.
...
La economía del sistema debe favorecer continuidad sin forzarla.
...
Cada decisión futura sobre créditos debe pasar esta prueba:
...
La arquitectura económica futura debe contemplar, como mínimo:
...
Esta estructura permite un sistema:
...
Los créditos son la pieza que permite escalar construcción y uso intensivo sin romper el modelo.



La exportación es la pieza que permite monetizar la salida sin degradar la continuidad interna.
